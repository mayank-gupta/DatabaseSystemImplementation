...
void q0 (){
  ...
  printf("result in test.cc = %f",result);
  if(fabs(800000	-result) >0.1)
...
int main(int argc, char *argv[]) {
  /*
     ...
     char *relName[] = { "part",  "lineitem"};
     s.AddRel(relName[0],200000);
     s.AddAtt(relName[0], "p_partkey",100000);
     s.AddAtt(relName[0], "d_partkey",300);
     s.CopyRel("part","p1");
