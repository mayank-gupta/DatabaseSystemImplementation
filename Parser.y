...
%type <myFile> MyFile
%type <myOutputDestination> OutputDestination
%type <myTableAttList> AttNameandType
%type <myType> Type
...
SQL: CREATE TABLE TableName '(' AttNameandType ')' AS FileType
{
	myTable = $3;
	pairList = $5;
	fileType = $8;
...
| CREATE TABLE TableName '(' AttNameandType ')' AS FileType ON Atts
{
	myTable = $3;
	pairList = $5;
	fileType = $8;
...
SQL: INSERT MyFile INTO TableName
{
	loadFile = $2;
	myTable = $4;
	queryId = 2;
...
SQL: SET OUTPUT OutputDestination
{
	outputDest = $3;
	queryId = 4;
};
SQL: UPDATE STATISTICS FOR TableName
{
	queryId = 6;
};
AttNameandType: Name Type
{
